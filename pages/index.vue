  ...
  <div class="">
    ...
    <div id="app">
        <vue-particles color="#fff"
                      ...
                      :clickEffect="true"
                      clickMode="push" 
                      style="width: 100%; height: 100%; background: #000"></vue-particles>
    
      <div class="test relative flex items-top justify-center min-h-screen bg-gray-100 sm:items-center sm:pt-0">
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
          ...
          <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
            <h2 class="text-2xl leading-7 font-semibold">
              Welcome to your Nuxt Application testing
            </h2>
